...
urlpatterns = [
    ...
    path('registration_choice/', views.RegistrationChoiceView.as_view(), name='registration_choice'),
    path('registration_student/', views.AlunoRegistrationView.as_view(), name='registration_student'),
    path('validate_professor/', views.ValidateProfessorView.as_view(), name='validate_professor'),
