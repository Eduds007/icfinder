"""
Django settings for icfinder project.
...
SECRET_KEY = "django-insecure-o$mi%zhk+gkri3fsdl=@hklc$%*&t7i_%5)q(9pe@ycjmf-_lx"
...
WSGI_APPLICATION = "icfinder.wsgi.application"
